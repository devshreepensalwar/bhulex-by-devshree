...
import 'package:my_bhulekh_app/validations_chan_lang/adhikarabhilekhvali.dart';
                ...
                children: <Widget>[
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      label: RichText(
                        text: TextSpan(
                          text: AdhikarAbhilekhStrings.getString(
                            'byName',
                            widget.isToggled,
                          ),
                          ...
                          children: [
                            TextSpan(
                              text:
                                  ' ${AdhikarAbhilekhStrings.getString('inCaseSurveyNotKnown', widget.isToggled)}',
                              style: const TextStyle(
                                color: Color(0xFF36322E),
                                fontSize: 10,
                                fontWeight: FontWeight.w400,
