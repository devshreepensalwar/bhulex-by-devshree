...
import 'package:my_bhulekh_app/onboarding_screens/onboarding_screen2.dart';
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                left: (screenWidth - 346) / 2,
                child: Container(
                  width: 346,
                  height: 50,
                  alignment: Alignment.center,
                  child: Text(
                    'Need 7/12 Utara, 8A Utara, Property Card, or Mutation details? We’ve got you covered!',
                    textAlign: TextAlign.center,
                    style: GoogleFonts.poppins(
                      fontSize: 15,
                  ...
                  onTap: () {
                    Navigator.pushReplacement(
                      ...
                      MaterialPageRoute(
                        builder:
                            (context) =>
                                OnboardingScreen2(), // Ensure this class is defined
                      ),
                    );
                  },
