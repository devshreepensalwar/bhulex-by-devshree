...
import 'package:my_bhulekh_app/profile/about_bhulex.dart';
import 'package:my_bhulekh_app/profile/change_language.dart';
import 'package:my_bhulekh_app/profile/disclaimer.dart';
import 'package:my_bhulekh_app/profile/help&support.dart';
import 'package:my_bhulekh_app/profile/notifications.dart';
import 'package:my_bhulekh_app/profile/privacy_policy.dart';
import 'package:my_bhulekh_app/profile/terms_and_conditions.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> fetchCustomer() async {
    ...
    print("🔗 Customer Profile API URL: $url");
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      title: Text(
                        isToggled ? 'नियम आणि अटी' : 'Terms & Conditions',
                        style: const TextStyle(color: iconTextColor),
                      ),
                      trailing: const Icon(
                        Icons.arrow_forward_ios,
...
//   void _showLogoutConfirmationDialog(BuildContext context) {
//     // ... (keeping your existing logout dialog code unchanged)
//     showModalBottomSheet(
//       context: context,
//       backgroundColor: Colors.white,
//       isScrollControlled: true,
...
//                     child: GestureDetector(
//                       onTap: () {
//                         showEditProfileImageBottomSheet(context);
//                       },
//                       child: CircleAvatar(
//                         radius: 20,
//                         backgroundColor: Colorfile.bordertheme,
...
//                       },
//                     ),
//                     Divider(height: 1, color: Color(0xFFF2F4F7)),
//                     ListTile(
//                       leading: Image.asset(
//                         'assets/privacy.png',
//                         width: 24,
